...
static std::vector<std::string> s_Preset_print_options {
    ...
    "max_acceleration_and_jerk_from_pa",
...
static std::vector<std::string> s_Preset_filament_options {
    ...
    //SoftFever
    "enable_pressure_advance", "pressure_advance","chamber_temperature", "filament_shrink","filament_shrinkage_compensation_z", "support_material_interface_fan_speed", "filament_notes" /*,"filament_seam_gap"*/,
